...
@RestController
@RequestMapping("/api/test-kk-kafka")
public class TestKkKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TestKkKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TestKkKafkaResource(KafkaProperties kafkaProperties) {
