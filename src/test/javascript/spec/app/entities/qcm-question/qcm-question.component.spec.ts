...
import { QcmQuestionComponent } from 'app/entities/qcm-question/qcm-question.component';
...
describe('Component Tests', () => {
  describe('QcmQuestion Management Component', () => {
    let comp: QcmQuestionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QcmQuestionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.qcmQuestions && comp.qcmQuestions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
