...
import { QcmTestComponent } from 'app/entities/qcm-test/qcm-test.component';
import { QcmTestService } from 'app/entities/qcm-test/qcm-test.service';
import { QcmTest } from 'app/shared/model/qcm-test.model';

describe('Component Tests', () => {
  describe('QcmTest Management Component', () => {
    let comp: QcmTestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QcmTestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.qcmTests && comp.qcmTests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
