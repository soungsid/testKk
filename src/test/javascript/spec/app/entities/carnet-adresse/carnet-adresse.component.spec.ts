...
import { CarnetAdresseComponent } from 'app/entities/carnet-adresse/carnet-adresse.component';
...
describe('Component Tests', () => {
  describe('CarnetAdresse Management Component', () => {
    let comp: CarnetAdresseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CarnetAdresseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.carnetAdresses && comp.carnetAdresses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
